...
public:
    ...
    void Compute() override
    {
        ...
        for (int i = 0; i < 20; ++i) {
            for (int j = 0; j < 17; ++j) {
                for (int k = 0; k < 4; ++k) {
                    horProductTemp *= square[i][j + k];
                }
                if (horProductTemp > horProductMax) {
                    horProductMax = horProductTemp;
                }
                horProductTemp = 1;
            }
        }
        ...
        for (int i = 0; i < 17; ++i) {
            for (int j = 0; j < 20; ++j) {
                for (int k = 0; k < 4; ++k) {
                        vertProductTemp *= square[i + k][j];
                }
                if (vertProductTemp > vertProductMax) {
                    vertProductMax = vertProductTemp;
                }
                vertProductTemp = 1;
            }
        }

        //computing diagDownProductMax
        for (int i = 0; i < 17; ++i) {
            for (int j = 0; j < 17; ++j) {
                for (int k = 0; k < 4; ++k) {
        ...
        //computing diagUpProductMax
        for (int i = 19; i > 2; --i) {
            for (int j = 0; j < 17; ++j) {
                for (int k = 0; k < 4; ++k) {
                    diagUpProductTemp *= square[i - k][j + k];
                }
                if (diagUpProductTemp > diagUpProductMax) {
                    diagUpProductMax = diagUpProductTemp;
                }
                diagUpProductTemp = 1;
            }
        }
